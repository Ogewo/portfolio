...
import { FaEnvelope, FaYoutube,FaTwitter, FaLinkedin, FaGithub} from 'react-icons/fa'

const Hero = () => {
  return (
    <section className='md:pt-10 md:px-[200px]' id='about'>
     <div className='container pt-14'>
        <div className='md:flex items-center justify-between sm:flex-col md:flex-row'>
            {/* ========= hero left content ========== */}
            <div className='flex flex-col items-center pt-4 md:pt-20 w-full md:basis-1/2'>
                ...
                <div data-aos='fade-up' data-aos-duration='1800' data-aos-delay='200' className='flex flex-col items-center justify-center gap-6 mt-7'>
                  <div className='flex items-center justify-between px-20 md:px-0 py-10 gap-10'>
                  <a href='#'>
                  ...
                  className=' text-center flex gap-2 text-headingColor mt-12 font-[500] text-[15px] leading-7'>
            ...
            {/* ========= hero left end ========== */}
            {/* ========= hero left image ========== */}
            <div className='sm:hidden lg:flex md:basis-3/4 mt-10 sm:mt-0 '>
